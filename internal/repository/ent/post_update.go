...
func (pu *PostUpdate) SetPublishedOn(t time.Time) *PostUpdate {
	pu.mutation.SetPublishedOn(t)
	return pu
}

// SetNillablePublishedOn sets the "published_on" field if the given value is not nil.
func (pu *PostUpdate) SetNillablePublishedOn(t *time.Time) *PostUpdate {
	if t != nil {
		pu.SetPublishedOn(*t)
	}
	return pu
...
func (pu *PostUpdate) SetIsDeleted(b bool) *PostUpdate {
	pu.mutation.SetIsDeleted(b)
	return pu
}

// SetNillableIsDeleted sets the "is_deleted" field if the given value is not nil.
func (pu *PostUpdate) SetNillableIsDeleted(b *bool) *PostUpdate {
	if b != nil {
		pu.SetIsDeleted(*b)
	}
	return pu
...
func (pu *PostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.PublishedOn(); ok {
...
// SetPublishedOn sets the "published_on" field.
func (puo *PostUpdateOne) SetPublishedOn(t time.Time) *PostUpdateOne {
	puo.mutation.SetPublishedOn(t)
	return puo
}

// SetNillablePublishedOn sets the "published_on" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillablePublishedOn(t *time.Time) *PostUpdateOne {
	if t != nil {
		puo.SetPublishedOn(*t)
	}
	return puo
}
...
// SetIsDeleted sets the "is_deleted" field.
func (puo *PostUpdateOne) SetIsDeleted(b bool) *PostUpdateOne {
	puo.mutation.SetIsDeleted(b)
	return puo
}

// SetNillableIsDeleted sets the "is_deleted" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillableIsDeleted(b *bool) *PostUpdateOne {
	if b != nil {
		puo.SetIsDeleted(*b)
	}
	return puo
...
func (puo *PostUpdateOne) sqlSave(ctx context.Context) (_node *Post, err error) {
	...
	if value, ok := puo.mutation.PublishedOn(); ok {
		_spec.SetField(post.FieldPublishedOn, field.TypeTime, value)
	}
